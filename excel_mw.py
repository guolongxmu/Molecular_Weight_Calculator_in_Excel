...
MM_of_Elements = {'H': 1.00794, 'He': 4.002602, 'Li': 6.941, 'Be': 9.012182, 'B': 10.811, 'C': 12.0107, 'N': 14.0067,
                  ...
                  'Me':15.03,'Et':29.06,'Pr':43.09,'Ph':77.01,'Bn':91.13,'Bimi':117.14,'Bimy':117.14,'Phen':198.22,'Pryn':39.06,
                  'Redox':199.19,'Bu':57.11,'Ac':43.04,'Mes':119.18,'Tf':133.07,'Cp':65.09,'Cy':83.15,'Tol':91.13,
                  'Dppy':263.27,'Dppm':384.39,'Dppe':398.42,'Dppp':412.44,'Py':78.1,'Hdpa':171.2,'Imi':68.08,
                  '': 0,'-':0,}
...
def molar_mass(compound: str, decimal_places=None) -> float:
    ...
    #print(count)
    # if count > 4:
    #     with open('E:\py\MW\mw.txt','a') as mw:
    #         baocun=compound+' , '+str(m_m)
    #         mw.write(baocun)
    #         mw.write('\n')
    if '*' in compound:
...
# try:
#     a=input('>>>')
#     print('%.2f'%molar_mass(a))
# except KeyError as error:
#     print(str(error))
if __name__ == "__main__":
    input_value = sys.argv[1]
    result = molar_mass(input_value)
    print(result)
